...
(function(mod) {
  ...
  CodeMirror.defineMode("lib", function (options) {
      ...
      var builtins = makeKeywords(
          "* *' *1 *2 *3 *agent* *allow-unresolved-vars* *assert* *lib-version* *command-line-args* *compile-files* " +
          ...
          "lib-version coll? comment commute comp comparator compare compare-and-set! compile complement completing concat cond condp " +
          ...
          "ref-min-history ref-set refer refer-lib reify release-pending-sends rem remove remove-all-methods " +
  ...
  CodeMirror.defineMIME("text/x-lib", "lib");
  CodeMirror.defineMIME("text/x-clojurescript", "lib");
  CodeMirror.defineMIME("application/edn", "lib");
